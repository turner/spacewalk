...
var grammar = {
    ...
    {"name": "wschar", "symbols": [/[ \t\n\v\f]/], "postprocess": id},
    {"name": "file", "symbols": ["trace_rows"], "postprocess": (d) => { return acc; }},
    {"name": "trace_rows", "symbols": ["trace_row"], "postprocess": (d) => { acc.push(d[0]); }},
    {"name": "trace_rows", "symbols": ["trace_rows", "trace_row"], "postprocess": (d) => { acc.push(d[1]); }},
